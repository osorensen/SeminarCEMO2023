...
Is it the tool cognitive neuroscience needs to discover?
...
- Can have $f_{s}(\mathbf{x}) = \mathbf{x}^{T}\boldsymbol{\beta}$, but this is more generic.
...
- Or should we all just resort to Stan?
